...
public class QualcommTestListenerTest extends QualcommTestListener {
    ...
    private QualcommTestSuite mockQualcommTestSuite;

    @Before
    public void setUp() {

        mockQualcommTestSuite = mock(QualcommTestSuite.class);
        setSessionIdProvider(mockQualcommTestSuite);
        ...
        IInvokedMethodListener listener = new QualcommTestListener();
        ...
        when(mockITestClass.getTestName()).thenReturn("[TestClass name=class com.qualcomm.ocp.automation.tests.web.BasicTest]");

        mockITestNGMethod = mock(ITestNGMethod.class);
        when(mockITestResult.getInstance()).thenReturn(mockQualcommTestSuite);
        ...
        when(mockQualcommTestSuite.getCurrentJobId()).thenReturn(VALID_JOB_ID);

    }

    @Test
    public void jobDoesNotExistInSauceLabsTest() {
        when(mockQualcommTestSuite.getCurrentJobId()).thenReturn(INVALID_JOB_ID);
