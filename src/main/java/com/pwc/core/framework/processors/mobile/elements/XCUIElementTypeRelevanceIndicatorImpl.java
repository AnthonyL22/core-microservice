...
public class XCUIElementTypeRelevanceIndicatorImpl implements MicroserviceMobileElement {
    ...
    public void mobileAction(final WebElement mobileElement, final Object attributeValue) {
        try {
            if (attributeValue == null) {
                LOG(true, "Click RELEVANCE INDICATOR %s", getElementText(mobileElement));
                mobileElement.click();
            } else {
