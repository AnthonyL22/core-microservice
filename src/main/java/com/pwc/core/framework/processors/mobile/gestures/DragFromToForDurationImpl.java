...
public class DragFromToForDurationImpl implements MicroserviceMobileElementGesture {
    ...
    public Map buildParameters(final MobileElement element, MobileGesture mobileGesture, Object customParameters) {
        ...
        try {
            ...
            if (null == customParameters) {
                defaultParameters.put("duration", 5);
                defaultParameters.put("fromX", 100);
                defaultParameters.put("fromY", 100);
                defaultParameters.put("toX", 200);
                defaultParameters.put("toY", 200);
            } else {
