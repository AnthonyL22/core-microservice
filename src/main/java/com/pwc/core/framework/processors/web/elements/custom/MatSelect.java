...
/**
 * Models a mat-select tag, providing helper methods to select and deselect options.
 */
public class MatSelect implements ISelect {

    private final WebElement element;
    private final boolean isMulti;

    /**
     * Constructor. A check is made that the given element is, indeed, a MAT-SELECT tag. If it is not,
     * then an UnexpectedTagNameException is thrown.
     *
     * @param element MAT-SELECT element to wrap
     * @throws UnexpectedTagNameException when element is not a MAT-SELECT
     */
    public MatSelect(WebElement element) {

        String tagName = element.getTagName();

        if (null == tagName || !WebElementType.MAT_SELECT.type.equals(tagName.toLowerCase())) {
            throw new UnexpectedTagNameException(WebElementType.MAT_SELECT.type, tagName);
        }
    ...
    /**
     * Get all options for the element.
     *
     * @return All options belonging to this mat-select tag
     */
    public List<WebElement> getOptions() {

        return element.findElements(By.tagName(WebElementType.MAT_OPTION.type));
    }

    /**
     * Get all selected options for the element.
     *
     * @return All selected options belonging to this mat-select tag
     */
    ...
    /**
     * Get substring without spaces.
     *
     * @param s string to interrogate
     * @return result
     */
    ...
    /**
     * Clear all selected entries. This is only valid when the MAT-SELECT supports multiple selections.
     *
     ...
     * @param value The value to match against
     * @throws NoSuchElementException        If no matching option elements are found
     * @throws UnsupportedOperationException If the MAT-SELECT does not support multiple selections
     */
