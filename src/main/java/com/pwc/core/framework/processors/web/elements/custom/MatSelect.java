...
//    if (null == tagName || !WebElementType.MAT_SELECT.type.equals(tagName.toLowerCase())) {
    if (null == tagName || !WebElementType.DIV.type.equals(tagName.toLowerCase())) {
  ...
  public List<WebElement> getOptions() {
    return element.findElements(By.tagName("mat-option"));
  }
  ...
  public void selectByVisibleText(String text) {
    ...
    if (options.isEmpty() && text.contains(" ")) {
      ...
      if ("".equals(subStringWithoutSpace)) {
        ...
        candidates = element.findElements(By.tagName("mat-option"));
      } else {
